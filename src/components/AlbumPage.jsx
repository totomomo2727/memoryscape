...
const AlbumPage = forwardRef(function AlbumPage({ page, pageNumber, onSetPhoto, onClearPhoto, onSetNote }, ref) {
  ...
  return (
    <div ref={ref} className="relative flex h-full w-full flex-col gap-2 px-6 py-3">
      <div
      ...
      <span className="font-hand pointer-events-none relative text-sm text-ink-soft/70 [text-shadow:0_1px_2px_rgba(255,255,255,0.6)]">
        {pageNumber}
      </span>
    </div>
  );
